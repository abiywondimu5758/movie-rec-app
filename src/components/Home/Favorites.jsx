...
import { fetchFavorites } from "../../Movies";
import { fetchSeriesFavorites } from "../../Series";
  ...
  const fetchUserData = useCallback(async () => {
    ...
    try {
      const [moviesData, seriesData] = await Promise.all([
        ...
        fetchSeriesFavorites(currentUser.uid)
      ]);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          All your hearted movies and series in one place
        </p>
      </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Start hearting movies and series to see them here
            </p>
